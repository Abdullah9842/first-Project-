...
//   const { email } = useParams<{ email: string }>(); // الحصول على البريد الإلكتروني من الرابط
//   const [posts, setPosts] = useState<Post[]>([]); // حالة المنشورات
//   const [text, setText] = useState<string>(""); // حالة نص المنشور
//   const [showForm, setShowForm] = useState<boolean>(false); // حالة عرض الفورم
//   const [image, setImage] = useState<string | null>(null); // حالة الصورة
//   const [spotifyUrl, setSpotifyUrl] = useState<string>(""); // حالة رابط Spotify

//   // تحميل المنشورات من localStorage عند تحميل الصفحة
//   useEffect(() => {
...
//         <img
//           src="https://via.placeholder.com/150" // استبدلها بصورة المستخدم
//           alt="Profile"
